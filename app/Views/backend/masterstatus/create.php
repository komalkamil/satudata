...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form">
                    <form action="/backend/masterstatus/save" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label>Nama Status</label>
                            <input type="text" class="form-control  <?= (session('validation')) ? 'is-invalid' : ''; ?>" autofocus placeholder="Masukan Status" name="nm_status" value="<?= old('nm_status'); ?>">
