                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-append">
                            ...
                            <button class="btn btn-rounded btn-primary" type="button">
                                <a href="/backend/masterpusats/create" class="text-white" style="text-decoration: none;"><i class="fas fa-add"></i> <span class="mx-2" style="font-size: 16px;">Tambah</span></a>
                            </button>
                    ...
                    <tbody>
                        ...
                        foreach ($divisi as $r): ?>
                            <tr>
                                ...
                                <td><?= $r['nm_divisi']; ?></td>
                                <td><?= $r['akronim']; ?></td>
                                <td><img style="width: 200px;" src="/img/<?= $r['path']; ?>" alt="" srcset=""> </td>
                                <td><?= $r['penulis']; ?></td>
                                <td><?= $r['created_at']; ?></td>
                                <td><?= $r['updated_at']; ?></td>
                                <td>
                                    <a href="/backend/masterpusats/<?= $r['slug']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-pencil"></i></a>
                                    <form action="/backend/masterpusats/<?= $r['id']; ?>" class="d-inline" method="post">
                                        <?= csrf_field(); ?>
