...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form">
                    <form action="/backend/masterformatdatas/save" method="post">
                        <div class="form-group">
                            <label>Nama Format Data</label>
                            <input type="text" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" placeholder="Masukan Format Data" name="format_data">
